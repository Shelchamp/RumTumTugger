        ...
        <div className="new-post-buttons post post-full is-mine with-avatar new-post">
          <nav className="post-buttons clearfix">
            ...
            */}
            <div className="post-button-div">
              <Link
                ...
                id="new-post-label-text"
              >
                <i className="icon-post-text">
                  <img src="https://i.imgur.com/jbKwECr.png" />
                </i>
                <span className="new-post-label-text">Text</span>
              </Link>
              {/*
            IMAGE POST FORM
            */}
              <Link
                to="/feed/imageform"
                className="new-post-label"
                id="new-post-label-photo"
              >
                <i className="icon-post-photo">
                  <img src="https://i.imgur.com/B1h1t9v.png" />
                </i>
                <span className="new-post-label-photo">Photo</span>
              </Link>
              {/*
            QUOTE POST FORM
            <Link
              to="/feed/quoteform"
              className="new-post-label"
              id="new-post-label-quote"
            >
              <i className="icon-post-quote cold">
                <img src="https://i.imgur.com/69rvy98.png" />
              </i>
              <span className="new-post-label-quote">Quote</span>
            </Link>
            */}
              {/*
            LINK POST FORM
            ...
            */}
            ...
            <Link
              to="/feed/audioform"
              className="new-post-label"
              id="new-post-label-audio"
            >
              <i className="icon-post-audio cold">
                <img src="https://i.imgur.com/kaNlsxF.png" />
              </i>
              <span className="new-post-label-audio">Audio</span>
            </Link>
            */}
              {/*
            VIDEO POST FORM
          */}
              <Link
                to="/feed/videoform"
                className="new-post-label"
                id="new-post-label-video"
              >
                <i className="icon-post-video">
                  <img src="https://i.imgur.com/pMVNlLX.png" />
                </i>
                <span className="new-post-label-video">Video</span>
              </Link>
            </div>
          </nav>
          <div className="post-avatar tumblelog-avatar" />
        </div>
      </li>
    );
  }
